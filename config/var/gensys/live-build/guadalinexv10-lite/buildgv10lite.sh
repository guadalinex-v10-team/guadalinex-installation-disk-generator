...
_LB_PATH=/var/gensys/live-build/guadalinexv10-lite
...
mkdir -p /srv/guadalinex-lite.mnt
mount -o loop ${_LB_PATH}/binary.hybrid.iso /srv/guadalinex-lite.mnt
rm -fr /srv/guadalinex-lite
mkdir -p /srv/guadalinex-lite
cp -a /srv/guadalinex-lite.mnt/* /srv/guadalinex-lite
cp -a /srv/guadalinex-lite.mnt/.disk /srv/guadalinex-lite/.disk
cp -a /srv/guadalinex-lite.mnt/preseed/* /var/gensys/deb-repositories/isos/preseed-guadalinex/
umount /srv/guadalinex-lite.mnt
